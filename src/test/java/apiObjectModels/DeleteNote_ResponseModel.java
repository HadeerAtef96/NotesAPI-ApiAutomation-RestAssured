...
public class DeleteNote_ResponseModel {
    //Variables
    Response response;

    //Constructor
    public DeleteNote_ResponseModel(Response response) {
        this.response = response;
    }

    //Method to Verify Values from Response
    @Step
    public DeleteNote_ResponseModel verifyMessageFromResponse(String expectedMessage){
    ...
    @Step
    public DeleteNote_ResponseModel verifyResponseStatusCode(String expectedCode) {
    ...
    @Step
    public DeleteNote_ResponseModel verifyResponseTimeLessThanTimeout(String expectedTimeOut) {
