...
public class Logout_ResponseModel {
    //Variables
    Response response;

    //Constructor
    public Logout_ResponseModel(Response response) {
        this.response = response;
    }

    //Method to Verify Values from Response
    @Step
    public Logout_ResponseModel verifyMessageFromResponse(String expectedMessage){
    ...
    @Step
    public Logout_ResponseModel verifyResponseStatusCode(String expectedCode) {
    ...
    @Step
    public Logout_ResponseModel verifyResponseTimeLessThanTimeout(String expectedTimeOut) {
